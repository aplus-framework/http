...
class Request extends Message //implements RequestInterface
{
	...
	/**
	 * @param null|string $name Input form name
	 *
	 ...
	 * @param bool $parse
	 *
	 * @return string|\Framework\HTTP\URL|null
	 */
	 ...
	 *
	 * @return string|\Framework\HTTP\URL The URL string or the URL object.
	 */
	public function getURL(bool $as_object = false)
	{
		...
		if ($port && ! \in_array($this->getPort(), [80, 443]))
		{
			$url .= ':' . $this->getPort();
		}
	 ...
	 *
	 * @return string|\Framework\HTTP\UserAgent|null The User Agent string, UserAgent object or
